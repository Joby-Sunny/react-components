      ...
      colItems: [
        ...
        { cellId: 1, cellType: "EMPTY_GEL_HOLDER" },
        {
          ...
          gelItems: [
            ...
            { getId: 1, gelType: "LABEL", height: 100, opacity: 1, value: 800 },
            { getId: 2, gelType: "LABEL", height: 100, opacity: 1, value: 500 },
            { getId: 3, gelType: "LABEL", height: 100, opacity: 1, value: 300 },
            { getId: 4, gelType: "LABEL", height: 100, opacity: 1, value: 100 },
          ],
        },
      ...
      colItems: [
        ...
        { colId: 1, cellType: "GEL_HOLDER", gelItems: [] },
        {
          ...
          gelItems: [
            ...
            { getId: 1, gelType: "FIXED", height: 100, opacity: 1, value: 800 },
            { getId: 2, gelType: "FIXED", height: 100, opacity: 1, value: 500 },
            { getId: 3, gelType: "FIXED", height: 100, opacity: 1, value: 300 },
            { getId: 4, gelType: "FIXED", height: 100, opacity: 1, value: 100 },
          ],
        },
        {
          colId: 3,
